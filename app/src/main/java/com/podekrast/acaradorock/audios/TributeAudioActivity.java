...
public class TributeAudioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = ConfigFirebase.getDatabase().child("audios").child("Tribute");
        ...
        layoutManager = new LinearLayoutManager(TributeAudioActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        //Adiciona um adapter para a RecyclerView
        adapter = new AdapterAudio(titlesList, TributeAudioActivity.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(TributeAudioActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(TributeAudioActivity.this, PlayerAudioActivity.class);
    ...
    public void tributeAudioReturn(View view) {
        finish();
    }
}
