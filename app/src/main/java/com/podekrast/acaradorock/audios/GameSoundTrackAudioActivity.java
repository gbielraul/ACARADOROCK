...
public class GameSoundTrackAudioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_game_sound_track_audio);
        //Recupera a referência do programa no FirebaseDatabase
        reference = ConfigFirebase.getDatabase().child("audios").child("GameSoundTrack");
        ...
        layoutManager = new LinearLayoutManager(GameSoundTrackAudioActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        //Adiciona um adapter para a RecyclerView
        adapter = new AdapterAudio(titlesList, GameSoundTrackAudioActivity.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(GameSoundTrackAudioActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(GameSoundTrackAudioActivity.this, PlayerAudioActivity.class);
    ...
    public void gameSoundTrackAudioReturn(View view) {
        finish();
    }
}
