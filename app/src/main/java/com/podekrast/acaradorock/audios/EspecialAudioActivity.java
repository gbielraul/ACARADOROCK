...
public class EspecialAudioActivity extends AppCompatActivity {

    private String programName = "Especial";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnReturn.setOnClickListener(especialReturn);
    ...
    private void setRecyclerClickListener() {
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(EspecialAudioActivity.this, PlayerAudioActivity.class);
    ...
    private View.OnClickListener especialReturn = v -> finish();
}
