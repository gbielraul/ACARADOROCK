...
public class UnderCoverAudioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_under_cover_audio);
        //Recupera a referência do programa no FirebaseDatabase
        reference = ConfigFirebase.getDatabase().child("audios").child("UnderCover");
        ...
        layoutManager = new LinearLayoutManager(UnderCoverAudioActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        //Adiciona um adapter para a RecyclerView
        adapter = new AdapterAudio(titlesList, UnderCoverAudioActivity.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(UnderCoverAudioActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(UnderCoverAudioActivity.this, PlayerAudioActivity.class);
    ...
    public void underCoverAudioReturn(View view) {
        finish();
    }
}
