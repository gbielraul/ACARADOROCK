...
public class
RockRollaAudioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rv_tribute_audio);
        //Recupera a referência do programa no FirebaseDatabase
        reference = ConfigFirebase.getDatabase().child("audios").child("RockRolla");
        ...
        layoutManager = new LinearLayoutManager(RockRollaAudioActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        //Adiciona um adapter para a RecyclerView
        adapter = new AdapterAudio(titlesList, RockRollaAudioActivity.this);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(RockRollaAudioActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(RockRollaAudioActivity.this, PlayerAudioActivity.class);
    ...
    public void rockRollaAudioReturn(View view) {
        finish();
    }
}
